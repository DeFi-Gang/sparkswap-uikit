...
var Svg = styled__default['default'].svg(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  fill: ", ";\n  flex-shrink: 0;\n\n  ", "\n  ", "\n"], ["\n  fill: ", ";\n  flex-shrink: 0;\n\n  ", "\n  ", "\n"])), function (_a) {
    var theme = _a.theme, color = _a.color, fill = _a.fill;
    return (fill !== "none" ? getThemeValue("colors." + color, color)(theme) : "none");
}, function (_a) {
    var spin = _a.spin;
...
var StyledButton = styled__default['default'].button(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n  align-items: center;\n  background-size: 150% auto;\n  background-color: ", ";\n  background-image: ", ";\n  border: ", ";\n  border-radius: 24px;\n  box-shadow: ", ";\n  color: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  /* max-content instead of auto for Safari fix */\n  width: ", ";\n  height: ", ";\n  line-height: 1;\n  letter-spacing: 0.03em;\n  justify-content: center;\n  outline: 0;\n  padding: ", ";\n  transition: ", ";\n  opacity: ", ";\n\n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    background-color: ", ";\n    background-image: ", ";\n\n    border-color: ", ";\n    background-position: right center;\n  }\n\n  &:focus:not(:active) {\n    box-shadow: 0 0 0 2px ", ";\n  }\n\n  &:active {\n    background-color: ", ";\n    box-shadow: ", ";\n  }\n\n  ", "\n  ", "\n  ", "\n"], ["\n  align-items: center;\n  background-size: 150% auto;\n  background-color: ",
    ";\n  background-image: ", ";\n  border: ", ";\n  border-radius: 24px;\n  box-shadow: ", ";\n  color: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  /* max-content instead of auto for Safari fix */\n  width: ", ";\n  height: ", ";\n  line-height: 1;\n  letter-spacing: 0.03em;\n  justify-content: center;\n  outline: 0;\n  padding: ", ";\n  transition: ", ";\n  opacity: ", ";\n\n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    background-color: ",
    ";\n    background-image: ", ";\n\n    border-color: ", ";\n    background-position: right center;\n  }\n\n  &:focus:not(:active) {\n    box-shadow: 0 0 0 2px ", ";\n  }\n\n  &:active {\n    background-color: ", ";\n    box-shadow: ", ";\n  }\n\n  ", "\n  ", "\n  ", "\n"])), function (props) {
    return props.variant === variants.PRIMARY ? "none" : getButtonVariantProp("background")(props);
}, function (props) { return (props.variant === variants.PRIMARY ? props.theme.colors.gradients.button : "none"); }, getButtonVariantProp("border"), getButtonVariantProp("boxShadow"), getButtonVariantProp("color"), function (_a) {
...
}, function (props) { return (props.variant === variants.PRIMARY ? "0.4s" : "background-color 0.2s"); }, function (_a) {
    var isLoading = _a.isLoading;
    return (isLoading ? 0.5 : 1);
}, function (props) {
    return props.variant === variants.PRIMARY ? "none" : getButtonVariantProp("backgroundHover")(props);
}, function (props) { return (props.variant === variants.PRIMARY ? props.theme.colors.gradients.main : "none"); }, getButtonVariantProp("borderColorHover"), function (_a) {
    var theme = _a.theme;
...
var Icon$7 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ width: "20", height: "20", viewBox: "0 0 20 20", fill: "none" }, props),
        React__default['default'].createElement("g", { clipPath: "url(#clip0_2197_2017)" },
            React__default['default'].createElement("path", { d: "M15.416 8.33333L10.416 13.3333L5.41602 8.33333", stroke: "#E9E9E9", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" })),
        React__default['default'].createElement("defs", null,
            React__default['default'].createElement("clipPath", { id: "clip0_2197_2017" },
                React__default['default'].createElement("rect", { width: "20", height: "20", fill: "white" })))));
};

var Icon$8 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20", fill: "none" }, props),
        React__default['default'].createElement("path", { d: "M4.58203 11.6667L9.58203 6.66667L14.582 11.6667", stroke: "#E9E9E9", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" })));
};
...
var Handle = styled__default['default'].div(templateObject_1$t || (templateObject_1$t = __makeTemplateObject(["\n  background-color: ", ";\n  border-radius: 50%;\n  cursor: pointer;\n  height: 28px;\n  left: 6px;\n  position: absolute;\n  top: 6px;\n  transition: left 200ms ease-in;\n  width: 28px;\n  z-index: 1;\n  box-shadow: ", ";\n"], ["\n  background-color: ", ";\n  border-radius: 50%;\n  cursor: pointer;\n  height: 28px;\n  left: 6px;\n  position: absolute;\n  top: 6px;\n  transition: left 200ms ease-in;\n  width: 28px;\n  z-index: 1;\n  box-shadow: ", ";\n"])), function (_a) {
    ...
    return theme.colors[checked ? "secondaryBright" : "card"];
}, function (_a) {
    var theme = _a.theme;
    return theme.shadows.focus;
});
...
var Toggle = function (_a) {
    ...
    return (React__default['default'].createElement(StyledToggle, null,
        React__default['default'].createElement(Input$1, __assign({ checked: checked }, props, { type: "checkbox" })),
        React__default['default'].createElement(Handle, { checked: isChecked })));
};
...
var shadows = {
    ...
    focus: "0px 0px 0px 1px #EC10BC, 0px 0px 2px 4px rgb(127 23 114 / 40%)",
        ...
        React__default['default'].createElement(ModalHeader, null,
            React__default['default'].createElement(ModalTitle, null,
                onBack && (React__default['default'].createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
                    React__default['default'].createElement(Icon$5, { color: "scondarye" }))),
...
var StyledToastContainer = styled__default['default'].div(templateObject_1$y || (templateObject_1$y = __makeTemplateObject(["\n  .enter,\n  .appear {\n    opacity: 0.01;\n  }\n\n  .enter.enter-active,\n  .appear.appear-active {\n    opacity: 1;\n    transition: opacity 250ms ease-in;\n  }\n\n  .exit {\n    opacity: 1;\n  }\n\n  .exit.exit-active {\n    opacity: 0.01;\n    transition: opacity 250ms ease-out;\n  }\n"], ["\n  .enter,\n  .appear {\n    opacity: 0.01;\n  }\n\n  .enter.enter-active,\n  .appear.appear-active {\n    opacity: 1;\n    transition: opacity 250ms ease-in;\n  }\n\n  .exit {\n    opacity: 1;\n  }\n\n  .exit.exit-active {\n    opacity: 0.01;\n    transition: opacity 250ms ease-out;\n  }\n"])));
...
var Icon$N = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 33" }, props),
        React__default['default'].createElement
621 10.0776 16.2753 10.4803 15.8279C10.8829 15.3805 11.4442 15.1078 12.0447 15.0677C12.6453 15.1078 13.2066 15.3805 13.6092 15.8279C14.0119 16.2753 14.2242 16.8621 14.201 17.4636C14.2242 18.065 14.0119 18.6518 13.6092 19.0992C13.2066 19.5466 12.6453 19.8193 12.0447 19.8594ZM19.999 19.8594C19.3995 19.8164 18.84 19.5428 18.438 19.0961C18.0359 18.6493 17.8226 18.0642 17.8427 17.4636C17.8195 16.8621 18.0318 16.2753 18.4345 15.8279C18.8371 15.3805 19.3984 15.1078 19.999 15.0677C20.6006 15.1048 21.1637 15.3767 21.567 15.8247C21.9702 16.2728 22.1815 16.8613 22.1552 17.4636C22.1815 18.0658 21.9702 18.6543 21.567 19.1024C21.1637 19.5505 20.6006 19.8223 19.999 19.8594Z", fill: "white" })),
        React__default['default'].createElement("defs", null,
            React__default['default'].createElement("clipPath", { id: "clip0_440_1727" },
                React__default['default'].createElement("rect", { width: "24", height: "24", fill: "white", transform: "translate(4 4.22131)" })))));
};

var Logo = function (_a) {
    var props = __rest(_a, []);
    return (React__default['default'].createElement(Svg, __assign({ width: "187", height: "18", viewBox: "0 0 187 18", fill: "none" }, props),
        React__default['default'].createElement("path", { d: "M3.81222 18C3.22022 18 2.67622 17.856 2.18022 17.568C1.70022 17.28 1.31622 16.888 1.02822 16.392C0.740219 15.896 0.596219 15.352 0.596219 14.76V13.608H3.47622V14.664C3.47622 14.792 3.51622 14.896 3.59622 14.976C3.67622 15.056 3.78022 15.096 3.90822 15.096H14.5162C14.6442 15.096 14.7482 15.056 14.8282 14.976C14.9242 14.896 14.9722 14.792 14.9722 14.664V11.232C14.9722 11.12 14.9242 11.024 14.8282 10.944C14.7482 10.848 14.6442 10.8 14.5162 10.8H3.81222C3.22022 10.8 2.67622 10.656 2.18022 10.368C1.70022 10.08 1.31622 9.696 1.02822 9.216C0.740219 8.72 0.596219 8.176 0.596219 7.584V3.96C0.596219 3.368 0.740219 2.824 1.02822 2.328C1.31622 1.832 1.70022 1.44 2.18022 1.152C2.67622 0.863999 3.22022 0.719999 3.81222 0.719999H14.6362C15.2282 0.719999 15.7642 0.863999 16.2442 1.152C16.7402 1.44 17.1322 1.832 17.4202 2.328C17.7242 2.824 17.8762 3.368 17.8762 3.96V5.112H14.9722V4.056C14.9722 3.928 14.9242 3.824 14.8282 3.744C14.7482 3.664 14.6442 3.624 14.5162 3.624H3.90822C3.78022 3.624 3.67622 3.664 3.59622 3.744C3.51622 3.824 3.47622 3.928 3.47622 4.056V7.488C3.47622 7.6 3.51622 7.704 3.59622 7.8C3.67622 7.88 3.78022 7.92 3.90822 7.92H14.6362C15.2282 7.92 15.7642 8.064 16.2442 8.352C16.7402 8.64 17.1322 9.032 17.4202 9.528C17.7242 10.008 17.8762 10.544 17.8762 11.136V14.76C17.8762 15.352 17.7242 15.896 17.4202 16.392C17.1322 16.888 16.7402 17.28 16.2442 17.568C15.7642 17.856 15.2282 18 14.6362 18H3.81222ZM20.9529 18V0.743999H34.9929C35.5849 0.743999 36.1209 0.895999 36.6009 1.2C37.0969 1.488 37.4889 1.88 37.7769 2.376C38.0809 2.856 38.2329 3.392 38.2329 3.984V8.736C38.2329 9.312 38.0809 9.848
2.824 101.327 2.328C101.615 1.832 101.999 1.44 102.479 1.152C102.975 0.863999 103.519 0.719999 104.111 0.719999H114.935C115.527 0.719999 116.063 0.863999 116.543 1.152C117.039 1.44 117.431 1.832 117.719 2.328C118.023 2.824 118.175 3.368 118.175 3.96V5.112H115.271V4.056C115.271 3.928 115.223 3.824 115.127 3.744C115.047 3.664 114.943 3.624 114.815 3.624H104.207C104.079 3.624 103.975 3.664 103.895 3.744C103.815 3.824 103.775 3.928 103.775 4.056V7.488C103.775 7.6 103.815 7.704 103.895 7.8C103.975 7.88 104.079 7.92 104.207 7.92H114.935C115.527 7.92 116.063 8.064 116.543 8.352C117.039 8.64 117.431 9.032 117.719 9.528C118.023 10.008 118.175 10.544 118.175 11.136V14.76C118.175 15.352 118.023 15.896 117.719 16.392C117.431 16.888 117.039 17.28 116.543 17.568C116.063 17.856 115.527 18 114.935 18H104.111ZM126.332 18L120.044 0.719999H123.116L127.484 12.696L131.852 0.719999H134.78L139.172 12.696L143.54 0.719999H146.612L140.324 18H137.996L133.316 5.16L128.636 18H126.332ZM148.428 18V3.96C148.428 3.368 148.572 2.824 148.86 2.328C149.148 1.832 149.54 1.44 150.036 1.152C150.532 0.863999 151.076 0.719999 151.668 0.719999H162.468C163.06 0.719999 163.596 0.863999 164.076 1.152C164.572 1.44 164.964 1.832 165.252 2.328C165.556 2.824 165.708 3.368 165.708 3.96V18H162.804V12.072H151.308V18H148.428ZM151.308 9.192H162.804V4.056C162.804 3.928 162.756 3.824 162.66 3.744C162.58 3.664 162.484 3.624 162.372 3.624H151.74C151.628 3.624 151.524 3.664 151.428 3.744C151.348 3.824 151.308 3.928 151.308 4.056V9.192ZM168.922 18V0.743999H182.962C183.554 0.743999 184.09 0.895999 184.57 1.2C185.066 1.488 185.458 1.88 185.746 2.376C186.05 2.856 186.202 3.392 186.202 3.984V8.736C186.202 9.312 186.05 9.848 185.746 10.344C185.458 10.84 185.066 11.232 184.57 11.52C184.09 11.808 183.554 11.952 182.962 11.952L171.802 11.976V18H168.922ZM172.234 9.048H182.866C182.978 9.048 183.074 9.008 183.154 8.928C183.25 8.848 183.298 8.744 183.298 8.616V4.056C183.298 3.944 183.25 3.848 183.154 3.768C183.074 3.672 182.978 3.624 182.866 3.624H172.234C172.122 3.624 172.018 3.672 171.922 3.768C171.842 3.848 171.802 3.944 171.802 4.056V8.616C171.802 8.744 171.842 8.848 171.922 8.928C172.018 9.008 172.122 9.048 172.234 9.048Z", fill: "#E9E9E9" })));
};

var Icon$R = function () {
    return (React__default['default'].createElement("svg", { width: "10", height: "11", viewBox: "0 0 10 11", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React__default['default'].createElement("path", { d: "M7.91667 8.63835H2.08333V2.80501H5V1.97168H1.25V9.47168H8.75V5.72168H7.91667V8.63835ZM5.83333 1.97168V2.80501H7.32917L3.23333 6.90085L3.82083 7.48835L7.91667 3.39251V4.88835H8.75V1.97168H5.83333Z", fill: "white" })));
};
...
var StyledWrapLogo = styled__default['default'].div(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n  display: flex;\n  flex-direction: ", ";\n  gap: 8px;\n  align-items: center;\n  ", " {\n    flex-direction: row;\n  }\n"], ["\n  display: flex;\n  flex-direction: ", ";\n  gap: 8px;\n  align-items: center;\n  ", " {\n    flex-direction: row;\n  }\n"])), function (_a) {
...
var Logo$1 = function (_a) {
    ...
    var innerLogo = (React__default['default'].createElement(StyledWrapLogo, { isFooter: isFooter },
        React__default['default'].createElement(Icon$q, { width: isFooter ? 82 : 35 }),
        React__default['default'].createElement(Logo, null)));
    return (React__default['default'].createElement(React__default['default'].Fragment, null, isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Sparkswap home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink$1, { to: href, "aria-label": "Sparkswap home page" }, innerLogo))));
};
Logo$1.defaultProps = {
    isFooter: false,
};
...
var UserBlock = function (_a) {
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null, account ? (React__default['default'].createElement(Button, { size: inHeader ? "sm" : "md", fullWidth: fullWidth, variant: "primary", onClick: function () {
            onPresentAccountModal();
        } }, accountEllipsis)) : (React__default['default'].createElement(Button, { size: inHeader ? "sm" : "md", fullWidth: fullWidth, onClick: function () {
...
var MobileMenuEntry = styled__default['default'].div(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  gap: 4px;\n  justify-content: flex-start;\n  height: ", "px;\n  padding: ", ";\n  font-size: 16px;\n  background-color: ", ";\n  color: ", ";\n  box-shadow: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    width: 10px;\n    fill: none;\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"], ["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  gap: 4px;\n  justify-content: flex-start;\n  height: ", "px;\n  padding: ", ";\n  font-size: 16px;\n  background-color: ", ";\n  color: ", ";\n  box-shadow: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    width: 10px;\n    fill: none;\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"])), MENU_ENTRY_HEIGHT, function (_a) {
    ...
    return (isActive ? "inset 4px 0px 0px " + theme.colors.secondaryBright : "none");
}, function (_a) {
...
var StyledFlex = styled__default['default'].div(templateObject_2$f || (templateObject_2$f = __makeTemplateObject(["\n  display: flex;\n  flex-direction: row;\n  margin: 0 auto;\n"], ["\n  display: flex;\n  flex-direction: row;\n  margin: 0 auto;\n"])));
var MobileMenuSideBar = function (props) {
    ...
    return (React__default['default'].createElement(StyledPanel, { showMenu: showMenu },
        ...
        React__default['default'].createElement(StyledFlex, null,
            React__default['default'].createElement(UserBlock, { account: account, login: login, logout: logout, inHeader: true }),
            profile && React__default['default'].createElement(Avatar, { profile: profile }))));
};
var templateObject_1$F, templateObject_2$f;

var NavHeaderEntry = styled__default['default'].div(templateObject_1$G || (templateObject_1$G = __makeTemplateObject(["\n  cursor: pointer;\n  border: 0;\n  padding-left: ", ";\n  font-size: 16px;\n  font-weight: 600;\n  height: ", "px;\n  gap: 4px;\n  display: flex;\n  align-items: center;\n  color: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n    font-size: 16px;\n    font-weight: 600;\n  }\n\n  svg {\n    width: 10px;\n    fill: none;\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  &:hover {\n    color: ", ";\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n"], ["\n  cursor: pointer;\n  border: 0;\n  padding-left: ", ";\n  font-size: 16px;\n  font-weight: 600;\n  height: ", "px;\n  gap: 4px;\n  display: flex;\n  align-items: center;\n  color: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n    font-size: 16px;\n    font-weight: 600;\n  }\n\n  svg {\n    width: 10px;\n    fill: none;\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  &:hover {\n    color: ", ";\n    svg {\n      path {\n        stroke: ", ";\n      }\n    }\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n"])), function (_a) {
    var isInAccordion = _a.isInAccordion;
    return (isInAccordion ? "16px" : 0);
}, MENU_ENTRY_HEIGHT, function (_a) {
    var theme = _a.theme, isActive = _a.isActive;
    return (isActive ? theme.colors.secondaryBright : theme.colors.tertiary);
}, function (_a) {
    var theme = _a.theme, isActive = _a.isActive;
    return (isActive ? theme.colors.primaryBright : theme.colors.tertiary);
}, function (_a) {
    var theme = _a.theme;
    return theme.colors.secondary;
}, function (_a) {
...
var StyledFooter = styled__default['default'].footer(templateObject_1$K || (templateObject_1$K = __makeTemplateObject(["\n  width: 100%;\n  border-top: 1px solid;\n  border-top-left-radius: 30px;\n  border-top-right-radius: 30px;\n  border-top-color: ", ";\n  background: ", ";\n  height: ", "px;\n  ", " {\n    height: ", "px;\n  }\n"], ["\n  width: 100%;\n  border-top: 1px solid;\n  border-top-left-radius: 30px;\n  border-top-right-radius: 30px;\n  border-top-color: ", ";\n  background: ", ";\n  height: ", "px;\n  ", " {\n    height: ", "px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.card;
}, function (_a) {
    var theme = _a.theme;
    return theme.colors.gradients.main;
}, FOOTER_HEIGHT_MOBILE, function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
}, FOOTER_HEIGHT);
var Container$6 = styled__default['default'].div(templateObject_2$h || (templateObject_2$h = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  gap: 32px;\n  padding: 0 15px;\n  width: 100%;\n  max-width: 1920px;\n  margin: 0 auto;\n  height: 100%;\n  ", " {\n    padding: 0 30px;\n    flex-direction: row;\n    justify-content: space-between;\n  }\n"], ["\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  gap: 32px;\n  padding: 0 15px;\n  width: 100%;\n  max-width: 1920px;\n  margin: 0 auto;\n  height: 100%;\n  ", " {\n    padding: 0 30px;\n    flex-direction: row;\n    justify-content: space-between;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
...
var Footer = function (_a) {
    var socialLinks = _a.socialLinks, logoLink = _a.logoLink, docs = _a.docs;
    ...
    return (React__default['default'].createElement(StyledFooter, null,
        React__default['default'].createElement(Container$6, null,
            React__default['default'].createElement(Logo$1, { href: logoLink, isFooter: true }),
...
var light$4 = {
    handleBackground: baseColors.secondaryBright,
};
var dark$4 = {
    handleBackground: baseColors.secondaryBright,
};
...
var light$6 = {
    background: lightColors.gradients.background,
};
var dark$6 = {
    background: darkColors.gradients.background,
};
